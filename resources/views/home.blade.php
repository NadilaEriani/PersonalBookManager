                            ...
                            <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                                ...
                                <div class="col-md-6 text-center">
                                    <div class="image-holder">
                                        <img src="/book/images/banner-image2.png" class="img-fluid" alt="banner">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="container">
                            <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                                ...
                                <div class="col-md-6 text-center">
                                    <div class="image-holder">
                                        <img src="/book/images/banner-image1.png" class="img-fluid" alt="banner">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="container">
                            <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                                ...
                                <div class="col-md-6 text-center">
                                    <div class="image-holder">
                                        <img src="/book/images/banner-image.png" class="img-fluid" alt="banner">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="card position-relative p-4 border rounded-3">
                                ...
                                <img src="/book/images/product-item1.png" class="img-fluid shadow-sm" alt="product item">
                        ...
                        <div class="swiper-slide">
                            <div class="card position-relative p-4 border rounded-3">
                                <img src="/book/images/product-item2.png" class="img-fluid shadow-sm" alt="product item">
                        ...
                        <div class="swiper-slide">
                            <div class="card position-relative p-4 border rounded-3">
                                <img src="/book/images/product-item3.png" class="img-fluid shadow-sm" alt="product item">
                        ...
                        <div class="swiper-slide">
                            <div class="card position-relative p-4 border rounded-3">
                                ...
                                <img src="/book/images/product-item4.png" class="img-fluid shadow-sm" alt="product item">
                        ...
                        <div class="swiper-slide">
                            <div class="card position-relative p-4 border rounded-3">
                                <img src="/book/images/product-item5.png" class="img-fluid shadow-sm" alt="product item">
                        ...
                        <div class="swiper-slide">
                            <div class="card position-relative p-4 border rounded-3">
                                <img src="/book/images/product-item6.png" class="img-fluid shadow-sm" alt="product item">
        ...
        <section id="limited-offer" class="padding-large"
            ...
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-md-6 text-center">
                        <div class="image-holder">
                            <img src="/book/images/banner-image3.png" class="img-fluid" alt="banner">
                        </div>
                    </div>
                    <div class="col-md-5 offset-md-1 mt-5 mt-md-0 text-center text-md-start">
                ...
                <div class="row">
                        ...
                        <div class="featured border rounded-3 p-4">
                            ...
                            <div class="items-lists">
                                <div class="item d-flex">
                                    <img src="/book/images/product-item2.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                ...
                                <hr class="gray-400">
                                <div class="item d-flex">
                                    <img src="/book/images/product-item1.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                                ...
                                <hr>
                                <div class="item d-flex">
                                    <img src="/book/images/product-item3.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                    ...
                    <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                        <div class="latest-items border rounded-3 p-4">
                            ...
                            <div class="items-lists">
                                <div class="item d-flex">
                                    <img src="/book/images/product-item4.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                                ...
                                <hr class="gray-400">
                                <div class="item d-flex">
                                    <img src="/book/images/product-item5.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                                ...
                                <hr>
                                <div class="item d-flex">
                                    <img src="/book/images/product-item6.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                    ...
                    <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                        <div class="best-reviewed border rounded-3 p-4">
                            ...
                            <div class="items-lists">
                                <div class="item d-flex">
                                    <img src="/book/images/product-item7.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                                ...
                                <hr class="gray-400">
                                <div class="item d-flex">
                                    <img src="/book/images/product-item8.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                                ...
                                <hr>
                                <div class="item d-flex">
                                    <img src="/book/images/product-item9.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                                        <h6 class="mb-0 fw-bold"><a href="index.html">Tales of the Enchanted Forest</a>
                                        </h6>
                                        <div class="review-content d-flex">
                                            <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                            <div class="rating text-warning d-flex align-items-center">
                    ...
                    <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                        <div class="on-sale border rounded-3 p-4">
                            ...
                            <div class="items-lists">
                                <div class="item d-flex">
                                    <img src="/book/images/product-item10.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                                ...
                                <hr class="gray-400">
                                <div class="item d-flex">
                                    <img src="/book/images/product-item11.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                                ...
                                <hr>
                                <div class="item d-flex">
                                    <img src="/book/images/product-item12.png" class="img-fluid shadow-sm"
                                        alt="product item">
                                    <div class="item-content ms-3">
                                        <h6 class="mb-0 fw-bold"><a href="index.html">Legends of the Dragon Isles</a>
                                        </h6>
                                        <div class="review-content d-flex">
                                            <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                            <div class="rating text-warning d-flex align-items-center">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 border-0 rounded-3 position-relative">
                            <a href="index.html">
                                <img src="/book/images/category1.jpg" class="img-fluid rounded-3" alt="cart item">
                                <h6 class=" position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3"><a
                                        href="index.html" class="text-white">Romance</a></h6>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-center mb-4 border-0 rounded-3">
                            <a href="index.html">
                                <img src="/book/images/category2.jpg" class="img-fluid rounded-3" alt="cart item">
                                <h6 class=" position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3"><a
                                        href="index.html" class="text-white">Lifestyle</a></h6>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-center mb-4 border-0 rounded-3">
                            <a href="index.html">
                                <img src="/book/images/category3.jpg" class="img-fluid rounded-3" alt="cart item">
                                <h6 class=" position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3"><a
                                        href="index.html" class="text-white">Recipe</a></h6>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 posts mb-4">
                        <img src="/book/images/post-item1.jpg" alt="post image" class="img-fluid rounded-3">
                        <a href="blog.html" class="fs-6 text-primary">Books</a>
                        <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.html">10 Must-Read Books of
                        ...
                        <p class="mb-2">Dive into the world of cutting-edge technology with our latest blog post, where
                            ...
                            five essential gadge. <span><a class="text-decoration-underline text-black-50"
                                    href="index.html">Read More</a></span>
                        </p>
                    </div>
                    <div class="col-md-3 posts mb-4">
                        <img src="/book/images/post-item2.jpg" alt="post image" class="img-fluid rounded-3">
                        <a href="blog.html" class="fs-6 text-primary">Books</a>
                        <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.html">The Fascinating Realm
                                of Science Fiction</a></h4>
                        <p class="mb-2">Explore the intersection of technology and sustainability in our latest blog
                            post. Learn about
                            the innovative <span><a class="text-decoration-underline text-black-50" href="index.html">Read
                                    More</a></span> </p>
                    </div>
                    <div class="col-md-3 posts mb-4">
                        <img src="/book/images/post-item3.jpg" alt="post image" class="img-fluid rounded-3">
                        <a href="blog.html" class="fs-6 text-primary">Books</a>
                        <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.html">Finding Love in the
                    ...
                    <div class="col-md-3 posts mb-4">
                        <img src="/book/images/post-item4.jpg" alt="post image" class="img-fluid rounded-3">
                        <a href="blog.html" class="fs-6 text-primary">Books</a>
                        <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.html">Reading for Mental
                    ...
                    <div class="col-md-2">
                        <figure class="instagram-item position-relative rounded-3">
                            <a href="https://templatesjungle.com/" class="image-link position-relative">
                                ...
                                <img src="/book/images/insta-item1.jpg" alt="instagram"
                    ...
                    <div class="col-md-2">
                        <figure class="instagram-item position-relative rounded-3">
                            <a href="https://templatesjungle.com/" class="image-link position-relative">
                                ...
                                <img src="/book/images/insta-item2.jpg" alt="instagram"
                                    class="img-fluid rounded-3 insta-image">
                            </a>
                        </figure>
                    </div>
                    <div class="col-md-2">
                        <figure class="instagram-item position-relative rounded-3">
                            <a href="https://templatesjungle.com/" class="image-link position-relative">
                                ...
                                <img src="/book/images/insta-item3.jpg" alt="instagram"
                                    class="img-fluid rounded-3 insta-image">
                            </a>
                        </figure>
                    </div>
                    <div class="col-md-2">
                        <figure class="instagram-item position-relative rounded-3">
                            <a href="https://templatesjungle.com/" class="image-link position-relative">
                                ...
                                <img src="/book/images/insta-item4.jpg" alt="instagram"
                                    class="img-fluid rounded-3 insta-image">
                            </a>
                        </figure>
                    </div>
                    <div class="col-md-2">
                        <figure class="instagram-item position-relative rounded-3">
                            <a href="https://templatesjungle.com/" class="image-link position-relative">
                                ...
                                <img src="/book/images/insta-item5.jpg" alt="instagram"
                                    class="img-fluid rounded-3 insta-image">
                            </a>
                        </figure>
                    </div>
                    <div class="col-md-2">
                        <figure class="instagram-item position-relative rounded-3">
                            <a href="https://templatesjungle.com/" class="image-link position-relative">
                                ...
                                <img src="/book/images/insta-item6.jpg" alt="instagram"
                                    class="img-fluid rounded-3 insta-image">
                            </a>
                        </figure>
                    </div>
